...
const MISSION_DATA = {
  ...
  body: "TOP is not a workout program. It's a complete performance architecture for your mind, body, and social identity — designed by pro athletes and psychologists for the next generation of elite operators. From your first day of operation to your first championship, we engineer the systems that make you unstoppable.",
};
